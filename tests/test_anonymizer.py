...
from tests.fixtures_global.fixtures_global_anonimizados import fixture_json_logs_anonymized
...
from tests.fixtures_global.fixtures_global_anonimizados import fixture_name_user_dictionary

from moodle_exam_miner.script1_anonymize_input import get_promedio_general, anonymize_log, anonymize_others
from operator import itemgetter


def test_get_promedio_general(fixture_json_marks):
    actual = get_promedio_general(fixture_json_marks)
...
def test_anonymize_log(fixture_json_logs, fixture_json_logs_anonymized, fixture_name_user_dictionary):
    ...
    actual = anonymize_log(fixture_json_logs, fixture_name_user_dictionary)
...
def test_anonymize_marks(fixture_json_marks, fixture_json_marks_anonymized, fixture_name_user_dictionary):
    fixture_json_marks = anonymize_others(fixture_json_marks, fixture_name_user_dictionary)
...
def test_anonymize_answers(fixture_json_answers, fixture_json_answers_anonymized, fixture_name_user_dictionary):
    fixture_json_answers = anonymize_others(fixture_json_answers, fixture_name_user_dictionary)
