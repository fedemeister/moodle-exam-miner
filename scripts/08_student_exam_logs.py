...
for i in range(0,merge_df.shape[0]):
    ...
    if (ip in lista_ip):
        ...
        json_particular_df.to_excel('files/tool_output/08_student_exam_logs/individual_logs/'+str(nombre)+'_'+str(nota)+"#"+str(json_particular_df.shape[0]) + '_ip_' +str(ip) + '.xlsx', index=False)
        ...
        json_particular_df.to_excel('files/tool_output/08_student_exam_logs/individual_logs/'+str(nombre)+'_'+str(nota)+"#"+str(json_particular_df.shape[0]) + '.xlsx', index=False)
